...
* Month of November
** Summary
    - In the first week of this month, I was working on DSL enhancement, which includes integration of the M.A.R.S. components of the SSS systems. 
    - Later, this task was transferred to Sadhna.
    - I am working on Ontologies definations using ADT graphs.
    - For building a graph, I found several libraries in Python.
    - I chose NetworkX for development purpose, because it creates graphs and vizualizations in graphviz files.
